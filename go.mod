module github.com/wuchongde/BaiduPCS-Go
...
require (
	...
	github.com/wuchongde/Baidu-Login v0.0.0-20221108143756-91d07b1fed79
	github.com/wuchongde/baidu-tools v0.0.0-20221108144220-17476c2df758
